Pod::Spec.new do |spec|
    ...
    if !Dir.exist?('build/cocoapods/framework/annotation.framework') || Dir.empty?('build/cocoapods/framework/annotation.framework')
        ...
        Kotlin framework 'annotation' doesn't exist yet, so a proper Xcode project can't be generated.
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:

            ./gradlew :annotation:generateDummyFramework

        Alternatively, proper pod installation is performed during Gradle sync in the IDE (if Podfile location is set)"
    end
                
    spec.pod_target_xcconfig = {
        'KOTLIN_PROJECT_PATH' => ':annotation',
        'PRODUCT_MODULE_NAME' => 'annotation',
    }
